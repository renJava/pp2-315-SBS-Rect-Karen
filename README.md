...
Практическая задача
Условие:
Клонируйте проект по ссылке и просмотрите его: https://github.com/KataAcademy/PP_3_1_2_Boot_Security.
...
3. Имплиментируйте модели Role и User интерфейсами GrantedAuthority и UserDetails соответственно. Измените настройку
